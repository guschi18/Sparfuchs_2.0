...
/**
 * Wishlist Button Component (Merkzettel)
 *
 * Displays a button with badge showing the number of items in the wishlist.
 * Used in the header to open/close the wishlist panel.
 *
 * Features:
 ...
 */
export function WishlistButton({ itemCount, onClick, isOpen = false }: WishlistButtonProps) {
  return (
    <motion.button
      onClick={onClick}
      ...
      aria-label={`Merkzettel öffnen (${itemCount} ${itemCount === 1 ? 'Eintrag' : 'Einträge'})`}
    >
      {/* Icon */}
