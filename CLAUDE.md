...
├── lib/              # Services & Utilities (AI, Data, Hooks)
...
- **UI**: `UI/` (ShoppingList, Toasts, MarketToggles)
...
### 🛠️ Utilities - Details in `docs/lib/utils/`
...
### 📚 Dependency Documentation - Details in `docs/dependency-docs.md`
...
### 🔧 Scripts & Systems - Details in `docs/scripts/`
